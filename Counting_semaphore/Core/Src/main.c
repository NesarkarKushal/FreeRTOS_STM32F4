...
int main(void)
{
 ...
 HAL_Init();
  ...
  signal=xSemaphoreCreateCounting(5,0);
//  signal= xSemaphoreCreateCountingStatic(5,0,&sembuff);
  ...
  {
	  xTaskCreate(TaskA,"My Task A",128,NULL,2,NULL);
